...
import { type ColumnSchema, columnFilterSchema } from '~/app/schema'
import type {
...
// import { searchParamsParser } from '~/lib/search.server'
import { LoaderCircle } from 'lucide-react'
import { Button } from '~/components/ui/button'
import { formatCompactNumber } from '~/lib/format'
import { inDateRange, arrSome } from '~/lib/table/filterfns'
import { DataTableSheetDetails } from '~/components/data-table/data-table-sheet/data-table-sheet-details'
import { TimelineChart } from '~/components/InfiniteDataTable/timeline-chart'
...
export interface DataTableInfiniteProps<TData, TValue, TMeta> {
  ...
  fetchNextPage: (options?: any | undefined) => void
}
...
export function DataTableInfinite<TData, TValue, TMeta>({
  ...
  // Fix this
  const [nuqsSearch, setSearch] = useQueryStates({
    uuid: parseAsString,
  })
  console.log('------- :', nuqsSearch)
  ...
  return (
    ...
    >
      <div
        className="flex w-full min-h-screen h-full flex-col sm:flex-row bg-black"
        style={
          {
