    ...
    <div className="flex flex-col gap-2">
      <div className="w-full flex justify-center items-center gap-2 p-1">
        <Button variant="ghost" size="sm" className="w-9 px-0" asChild>
          <Link to="https://github.com/openstatusHQ/data-table-filters">
            <Github className="h-4 w-4" />
          </Link>
        </Button>
        <Button variant="ghost" size="sm" className="w-9 px-0" asChild>
          <Link to="https://twitter.com/openstatusHQ">
            <Twitter className="h-4 w-4" />
          </Link>
        </Button>
        <Button variant="ghost" size="sm" className="w-9 px-0" asChild>
          <Link to="https://openstatus.dev">
      ...
      <p className="text-muted-foreground text-xs text-center">
        Powered by <Link to="https://openstatus.dev">OpenStatus</Link>
      </p>
      <p className="text-muted-foreground text-[10px] text-center">
        The data is mocked. It is in active development. For feedback, please{' '}
        <Link
          to="https://github.com/openstatusHQ/data-table-filters/issues/new"
