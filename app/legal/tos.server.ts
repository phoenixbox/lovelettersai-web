...
Effective as of Feb 12th, 2025.

This Privacy Policy describes how REPL Labs, LLC. ("REPL Labs," "we", “us” or "our") processes personal information that we collect through our digital or online properties or services that link to this Privacy Policy (including as applicable, our website, social media pages, marketing activities, live events and other activities described in this Privacy Policy (collectively, the “Service”)). REPL Labs may provide additional or supplemental privacy policies to individuals for specific products or services that we offer at the time we collect personal information.
...
- **Contact data**, such as your first and last name, salutation, email address, billing and mailing addresses, professional title and company name, and phone number. Demographic data, such as your city, state, country of residence, and postal code.
...
- **User-generated content data**, such as photos, images, audio or video recordings, text, comments, questions, messages, works of authorship, and other content or information that you generate, transmit, or otherwise make available on the Service, as well as associated metadata. Metadata includes information on how, when, where and by whom a piece of content was collected and how that content has been formatted or edited. Metadata also includes information that users can add or can have added to their content, such as keywords, geographical or location information, and other similar data. Users of the Service should not submit personally identifiable information, or other sensitive, confidential, or proprietary information into the Service.
...
If you connect the Service to a Google account, this Privacy Policy will apply to data collected from your Google account, such as your Google username, profile picture and other information associated with your Google account that is made available to us based on your account settings on that service. Our use and disclosure of information received from Google’s APIs will adhere to the Google API Services User Data Policy, including the Limited Use requirements. Notwithstanding anything else in this Privacy Policy, if you provide the Service access to your Google data, the Service’s use of that data will be subject to these additional restrictions:

- The Service will not access your Gmail messages or calendar.
- The Service will not use Google data for serving advertisements.
- The Service will not allow humans to read Google data in your Gmail messages or calendars unless we have your affirmative agreement for specific messages or email content, doing so is necessary for security purposes such as investigating abuse, to comply with applicable law, or for the Service’s internal operations (in such case only when the data have been aggregated or otherwise anonymized).
...
- provide, operate and improve the Service and our business; personalizing the service, including remembering the devices from which you have previously logged in and remembering your selections and preferences as you navigate the Service;
...
We and our service providers may collect and use your personal information for marketing purposes:

- **Direct marketing.** We may send you direct marketing communications and may personalize these messages based on your needs and interests. You may opt-out of our marketing communications as described in the [Opt-out of marketing](#your-choices) section below.
...
**Generative AI platforms.** We use third-party artificial intelligence (AI) providers, such as OpenAI, to provide certain aspects of the Service.
...
**Authorities and others.** Law enforcement, government authorities, and private parties, as we believe in good faith to be necessary or appropriate for the [Compliance and protection](#compliance-and-protection) purposes described above.

**Business transferees.** We may disclose personal information in the context of actual or prospective business transactions (e.g., investments in or financings of REPL Labs, public stock offerings, or the sale, transfer or merger of all or part of our business, assets or shares), for example, we may need to share certain personal information with prospective counterparties and their advisers. We may also disclose your personal information to an acquirer, successor, or assignee of REPL Labs as part of any merger, acquisition, sale of assets, or similar transaction, and/or in the event of an insolvency, bankruptcy, or receivership in which personal information is transferred to one or more third parties as one of our business assets.
...
**Do Not Track.** Some Internet browsers may be configured to send “Do Not Track” signals to the online services that you visit. We currently do not respond to “Do Not Track” signals. To find out more about “Do Not Track,” please visit [www.allaboutdnt.com](http://www.allaboutdnt.com).
...
Email: [privacy@repllabs.com](mailto:privacy@repllabs.com)`
